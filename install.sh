...
echo "[+] Done! Installed (SKILL.md routers; run per-skill scripts from the repo clone):"
echo "    - 31 kill-chain skills + a 6-skill discipline layer (37 SKILL.md routers)"
echo "    - 8 collaborative agents"
echo "    - 49 vulnerability/validation references"
echo "    - 20 engagement templates (9 Kill Chain phases)"
echo "    - 7 workflow definitions"
echo "    - 18 orchestration commands (/engage.*)"
echo "    - 7 engagement presets"
echo ""
echo "    Tip: install as a plugin (see README Method 0) to also auto-load the skill dispatcher."
